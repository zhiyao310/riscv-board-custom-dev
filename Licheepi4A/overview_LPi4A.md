...
- 处理器：XuanTie TH1520（4核 RISC-V RV64GCV C910@1.85GHz，集成4TOPS@int8 NPU + IMG BXM-4-64 GPU）

- 内存：LPDDR4X 可选4GB/8GB/16GB

- 存储：板载eMMC（可选16GB/32GB/64GB/128GB），1x Micro SD卡插槽

- 接口：

  -  网络：2x 千兆以太网端口（RJ45），部分版本支持POE供电

  - 显示：1x HDMI 2.0（支持4K@60fps输出），1x MIPI DSI接口

  - 摄像头：1x MIPI CSI 2-lane接口

  - USB：1x USB Type-C（数据+供电），3x USB 3.0 Type-A端口

  - 扩展：40针GPIO扩展接口（兼容树莓派布局），1x JTAG调试接口
