...
- Milk-V Pioneer
  ...
  - 设备型号截图
    ...
    ![device-model](./images/device-model.png)
  
  - 系统信息截图
  
    ![device-cpuinfo](./images/device-cpuinfo.png)
...
从[下载链接](https://drive.google.com/file/d/1-tYHNXjX6oekNorOGlWb_Az2nVOoey6y/view)下载你所需镜像。 **解压相关文件**

```
zstd -d revyos-pioneer-20250901-185948.img.zst
```
...
1. 将烧录好镜像的存储卡安装到Pioneer上，位于机箱背面，后面板最上侧的存储卡插槽
...
```
minicom -b 115200 -D /dev/ttyUSB0 或 tio /dev/ttyUSB0
...
![gnu-hello-compile](./images/gnu-hello-compile.png)

![gnu-hello-run](./images/gnu-hello-run.png)
...
![gnu-coremark-compile](./images/gnu-coremark-compile.png)

![gnu-coremark-run](./images/gnu-coremark-run.png)
...
![llvm-hello-compile](./images/llvm-hello-compile.png)

![llvm-hello-run](./images/llvm-hello-run.png)
...
![llvm-coremark-run](./images/llvm-coremark-run.png)
